...
import rtde_io
import rtde_receive
import GUI.screwdriver_socketIO as screwdriver_socketIO
from GUI.screwdriver_socketIO import get_screwdriver_data
...
import GUI.feeder_IO as feeder_IO # Zorg dat dit bovenaan staat
...
def screw_in(mode):
    if mode == 0:  # inschroeven bij oppak locatie
        ...
        feeder_IO.retract_actuator_now()
